...
public class AngleGenericRelativeEncoder implements AngleEncoder {
    Encoder encoder;
     ...
     */
    public AngleGenericRelativeEncoder(Encoder encoder) {
     ...
     */
    public AngleGenericRelativeEncoder(Encoder encoder, double gearRatio) {
     ...
     */
    public AngleGenericRelativeEncoder(Encoder encoder, Measure<? extends PerUnit<DimensionlessUnit,AngleUnit>> ppm) {
    ...
    public AngleGenericRelativeEncoder(Encoder encoder, Measure<? extends PerUnit<DimensionlessUnit,AngleUnit>> ppm, double gearRatio) {
